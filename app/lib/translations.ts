...
export const translations: Record<LanguageCode, TranslationDictionary> = {
  en: {
    ...
    "Unable to load BTC price.": "Unable to load BTC price.",
    Low: "Low",
    High: "High",
    Range: "Range",
  },
  es: {
    ...
    English: "Inglés",
    Spanish: "Español",
    "Google credential was not received.": "No se recibió la credencial de Google.",
    "Amount must be between {min} and {max} sats.":
    ...
    "Unable to load BTC price.": "No se pudo cargar el precio de BTC.",
    Low: "Mínimo",
    High: "Máximo",
    Range: "Rango",
  },
